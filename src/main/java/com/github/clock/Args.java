...
public class Args {
    ...
    @Option(name="-h", aliases="--long-hand-color", usage="長針の色を指定する。")
    private String longHndColor = "#ff0000";

    public String getLongHnadColor(){
        return longHndColor;
    }

    public void setLongHnadColor(String color){
        longHndColor = color;
    }
